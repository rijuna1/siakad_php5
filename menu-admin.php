<section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<li class="treeview">
              <a href="#"><i class="fa fa-user"></i> <span>Data Siswa</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="index.php?view=siswa"><i class="fa fa-circle-o"></i> Data Siswa</a></li>
                <li><a href="index.php?view=upload"><i class="fa fa-circle-o"></i> Import Siswa</a></li>
           ...
           <!-- <li class="treeview">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
				...
				<li><a href="index.php?view=absen"><i class="fa fa-circle-o"></i> Absensi Masuk Barcode</a></li>
				<li><a href="index.php?view=absen_kel"><i class="fa fa-circle-o"></i> Absensi Keluar Barcode</a></li>
				<li><a href="index.php?view=absen_moni"><i class="fa fa-circle-o"></i> Monitoring Absensi</a></li>
              </ul>
            </li>
