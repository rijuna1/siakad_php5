                              ...
                              if (isset($_GET[tahun]) AND isset($_GET[kelas])){
                                if($_SESSION[level]!='kepala'){
                                  echo "<td style='width:80px !important'><center>
                                          <a class='btn btn-primary btn-xs' title='Lihat Nilai Keterampilan Siswa' href='index.php?view=ledgermapel&act=listsiswasikap&jdwl=$r[kodejdwl]&kd=$r[kode_pelajaran]&id=$r[kode_kelas]&tahun=$_GET[tahun]'><span class='glyphicon glyphicon-search'></span> Lihat</a>
                                        </center></td>";
                                }
                              }
                            echo "</tr>";
...
elseif($_GET[act]=='listsiswasikap'){
    ...
    if (isset($_POST[simpandeskripsi])){
        ...
        echo "<script>document.location='index.php?view=ledgermapel&act=listsiswasikap&jdwl=$_GET[jdwl]&kd=$_GET[kd]&id=$_GET[id]&tahun=$_GET[tahun]';</script>";
    }
