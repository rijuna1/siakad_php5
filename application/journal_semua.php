                  ...
                  <table id='example' class='table table-bordered table-striped'>
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>$r[keterangan]</td>";
                                ...
                                echo "<td style='width:80px !important'><center>
                                        <a class='btn btn-success btn-xs' title='Edit Data' href='index.php?view=absensiswa&act=tampilabsen&id=$d[kode_kelas]&kd=$d[kode_pelajaran]&jdwl=$_GET[id]&gettgl=$r[tanggal]'><span class='glyphicon glyphicon-search'></span> Detail</a>
                                      </center></td>";
