      ...
      <div class="content-wrapper">
        ...
        <?php 
          ...
          elseif ($_GET[view]=='modul'){
            ...
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/import_siswa.php";
            echo "</div>";
          }elseif ($_GET[view]=='absen'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/absensi.php";
            echo "</div>";
          }elseif ($_GET[view]=='absen_kel'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/absensi_kel.php";
            echo "</div>";
          }elseif ($_GET[view]=='absen_moni'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/absensi_moni.php";
            echo "</div>";
			}
