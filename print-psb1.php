...
<?php
    ...
    $s = mysql_fetch_array($detail);
            echo "<table width=100%>
                      <tr><td width='90px'><img style='width:80px' src='print_raport/logoo.png'>
                          </td><td><b>$status DEK <br> BUSINESS SCHOOL </b><br> Jl.AR Hakim No.57 Telp. (0751) 21499 Padang</td></tr>
                  </table><hr>";
...
?>
Saya yang bertanda tangan dibawah ini , mendaftarkan anak saya sebagai siswa/i SMK DEK dan bersedia mengikuti persyaratan dan peraturan yang berlaku.
<br>
