...
<table style='border:1px solid #000' border='0' width='100%'>
  <tr>
    <td width=120px><img style='width:110px; margin-top:7px' src='print_raport/logooo.png'></td>
    <td><center>KARTU AKTIVASI PENDAFTARAN<br> PSB YAYASAN DEK PADANG</center></td>
    <td width=120px></td>
  </tr>
</table>
...
<tr><td>- Pendaftaran di alamat <span style='color:blue; text-decoration:underline'>http://dek.sch.id/psb</span></td></tr>
...
<tr><td>- Jika ada kendala lainnya bisa kontak kami di email. <span style='color:blue; text-decoration:underline'><?php echo "$r[status]@dek.sch.id"; ?></span></td></tr>
</table>
</body>
</html>