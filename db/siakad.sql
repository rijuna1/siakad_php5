...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 15, 2022 at 04:07 PM
...
(22, 1, 'XI.MIPA.1', '9990433931', 20161, 500000, '2022-09-14 20:02:15');
...
--
-- Table structure for table `rb_spp_periode`
--

CREATE TABLE `rb_spp_periode` (
  `id_spp_periode` int(11) NOT NULL,
  `tahun_ajar` varchar(100) NOT NULL,
  `periode_spp` varchar(100) NOT NULL
...
INSERT INTO `rb_tahun_akademik` (`id_tahun_akademik`, `nama_tahun`, `tahun_ajar`, `aktif`) VALUES
...
(20212, 'Tahun Ajar 2021 Genap', '2021/2022', 'Tidak'),
(20211, 'Semester Ganjil 2021/2022', '2021/2022', 'Ya');
...
(2, 'kepala', '12345', 'Dedek Setiawan', 'sdedek15@gmail.com', '087768151554', 'Kepala Sekolah', 'kepala', 'Y'),
(3, 'satpam', '12345', 'budi', 'ranggaaja65@ymail.com', '085276475777', 'satpam', 'satpam', 'Y'),
...
(366, '4', '::1', 'Chrome 105.0.0.0', 'Windows 10', 'superuser', '08:35:32', '2022-09-14'),
(367, '2', '::1', 'Chrome 105.0.0.0', 'Windows 10', '', '08:37:39', '2022-09-14'),
(368, '3', '::1', 'Chrome 105.0.0.0', 'Windows 10', '', '08:38:32', '2022-09-14'),
(369, '4', '::1', 'Chrome 105.0.0.0', 'Windows 10', 'superuser', '19:44:27', '2022-09-14'),
(370, '4', '::1', 'Chrome 105.0.0.0', 'Windows 10', 'superuser', '23:36:44', '2022-09-14'),
(371, '4', '::1', 'Chrome 105.0.0.0', 'Windows 10', 'superuser', '20:12:36', '2022-09-15');
...
--
-- Indexes for table `rb_spp_periode`
--
ALTER TABLE `rb_spp_periode`
  ADD PRIMARY KEY (`id_spp_periode`);
...
--
ALTER TABLE `rb_keuangan_bayar`
  MODIFY `id_keuangan_bayar` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `rb_keuangan_jenis`
--
ALTER TABLE `rb_keuangan_jenis`
  MODIFY `id_keuangan_jenis` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
-- AUTO_INCREMENT for table `rb_spp_periode`
--
ALTER TABLE `rb_spp_periode`
  MODIFY `id_spp_periode` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `rb_tahun_akademik`
  MODIFY `id_tahun_akademik` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20213;
...
--
ALTER TABLE `rb_users_aktivitas`
  MODIFY `id_users_aktivitas` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=372;
COMMIT;
